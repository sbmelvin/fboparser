...
CREATE UNLOGGED TABLE PRESOL (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE AMDCSS (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE ARCHIVE (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE AWARD (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE COMBINE (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE FAIROPP (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE FSTD (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE ITB (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE JA	 (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE MOD (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE SNOTE (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE SRCSGT (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE SSALE (LIKE FBO_RECORD);
CREATE UNLOGGED TABLE UNARCHIVE (LIKE FBO_RECORD);
...
/*CREATE INDEX ON NOTICES(OLD_ARCHDATE, OLD_RESPDATE, OLD_AWDDATE, OLD_YEAR, OLD_DATE);

UPDATE NOTICES SET ARCHDATE = TO_DATE(OLD_ARCHDATE, 'MMDDYYYY') WHERE OLD_ARCHDATE <> ' ';
UPDATE NOTICES SET RESPDATE = TO_DATE(OLD_RESPDATE, 'MMDDYY') WHERE OLD_RESPDATE <> ' ';
UPDATE NOTICES SET NOTICE_DATE = TO_DATE(OLD_DATE||OLD_YEAR, 'MMDDYY');
UPDATE NOTICES SET AWDDATE = TO_DATE(OLD_AWDDATE, 'MMDDYY') WHERE OLD_AWDDATE <> ' ';
...
ALTER TABLE NOTICES DROP COLUMN OLD_AWDDATE;
*/
COMMIT;
